...
function PolicyContent() {
  return (
    <section className="pt-32 pb-20 px-6 md:px-[130px] bg-[#ffffff] text-slate-800 font-serif">
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        {/* Policy Points */}
        <div className="space-y-10 text-[16px] leading-relaxed text-black/70">

          {/* Section 1 */}
          <FadeIn className="space-y-3">
            <h2 className="text-[#5B3231]/80 font-semibold text-[18px]" style={{ fontFamily: 'var(--font-seasons), Georgia, serif' }}>
              1. Statement
            </h2>
...
export default function PrivacyPolicyPage() {
  return (
    <div className="min-h-screen bg-white text-black/80 antialiased selection:bg-[#5B3231]/80 selection:text-white">
      <Header />
      <main>
        <PolicyContent />
      </main>
