...
function TermsContent() {
  return (
    <section className="pt-32 pb-20 px-6 md:px-[130px] text-slate-800 font-serif">
      <div className="max-w-4xl mx-auto space-y-12">
        {/* Page Title */}
        <FadeIn className="text-center pb-6">
          <h1 className="text-[32px] text-black/80 font-normal" style={{ fontFamily: 'var(--font-seasons), Georgia, serif' }}>
        ...
        <div className="space-y-10 text-[16px] leading-relaxed text-slate-700">
          ...
          <FadeIn className="space-y-3">
            <h2 className="text-[#5B3231]/80 font-semibold text-[18px]" style={{ fontFamily: 'var(--font-merriweather), Georgia, serif' }}>
              1. Definitions and Acceptance of Terms
            </h2>
            <p className="text-black/70" style={{ fontFamily: 'var(--font-merriweather), Georgia, serif' }}>
          ...
          <FadeIn className="space-y-3">
            ...
            <ul className="pl-4 space-y-1 text-black/70" style={{ fontFamily: 'var(--font-merriweather), Georgia, serif' }}>
...
export default function BookingTermsPage() {
  return (
    <div className="min-h-screen bg-white text-slate-900 antialiased selection:bg-[#5B3231] selection:text-white">
      <Header />
      <main>
        <TermsContent />
      </main>
